...
![My Skills](https://skillicons.dev/icons?i=nodejs,git,github,githubactions,linux,html,css,tailwind,bash,figma,ts,js,react,nextjs,electron,vite,c,cpp,swift,py,gcp,vscode,raspberrypi,docker,arduino&theme=dark)
